...
def score(input_dir, output_dir, data_split):
    ...
    output_file.close()
    print("Scores from ERRANT have been stored in the scores.txt file in the specified output directory")
    print("=============================")
...
def main():
    ...
    utils_transform_markdown_to_one_essay_per_line.split_to_parfiles_all(os.path.join(input_dir, 'ref'), os.path.join(input_dir, 'res'), data_split)
    # And run scoring function...
    print("=============================")
    print("Ok scoring the predictions files with ERRANT...")
    score(input_dir, output_dir, data_split)
